...
export const CATEGORIES: Category[] = [
  {
    slug: 'permit-fees',
    name: 'Permit Fees',
    tagline: 'What the city charges, invoice by invoice',
    accent: '#7a5195',
    intro:
      'Seattle bills its permit fees one invoice line at a time, and these pages check the math on all of it: what a permit really costs, when prices go up, the fee charged on other fees, and where the billed hours went. The data has a story: it started as a 1.4 million line public records request by this site in June 2026, and in September 2026 the city published it as a proper open dataset, Permit Fees, now refreshed here weekly.',
    entries: [
      {
      ...
      },
      {
        ...
        status: 'investigation',
        href: '/fees-housing',
        datasets: ['Permit Fees (k8z7-3feg)', 'Building Permits (76t5-zqzr)'],
      },
      {
        ...
        status: 'investigation',
        href: '/fees-hours',
        datasets: ['Permit Fees (k8z7-3feg)', 'Plan Review (tqk8-y2z5)'],
      },
    ],
  },
  {
